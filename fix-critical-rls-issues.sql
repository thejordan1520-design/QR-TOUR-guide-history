-- SCRIPT CRÍTICO: Corregir problemas de RLS que impiden registro de usuarios y pagos
...
-- 10. CREAR FUNCIÓN HELPER PARA VERIFICAR ADMIN
...
-- 11. CREAR FUNCIÓN HELPER PARA OBTENER USUARIO ACTUAL
...
-- 13. INSERTAR DATOS DE PRUEBA SI NO EXISTEN
...
-- 15. MENSAJE FINAL
SELECT 'RLS CRÍTICO CONFIGURADO EXITOSAMENTE' as status;
